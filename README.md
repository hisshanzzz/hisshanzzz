...
- Turning speech coaching problems into working software
- Making code mean something beyond assignments
- Proving that communication skills and engineering can live in the same person
...
[![Hisshan's github activity graph](https://github-readme-activity-graph.vercel.app/graph?username=hisshanzzz&theme=react-dark&hide_border=true)](https://github.com/ashutosh00710/github-readme-activity-graph)
...
|---------|--------------|
| [**SpeechLens**](https://github.com/hisshanzzz/speechlens) | Speech timing, filler words & readability analysis |
| [**ReCall**](https://github.com/hisshanzzz/recall) | AI voice companion for dementia patients — Team SustainX, Cursor Buildathon |
| [**The Stage**](https://github.com/hisshanzzz/Portfolio) | Portfolio with spotlight cursor & live SpeechLens demo |
| [**JV Pirates**](https://github.com/hisshanzzz/JVPirates) | 2D Pygame game — Team Typhoons, American Center Colombo |
...
| Achievement | Detail |
|-------------|--------|
| Provincial **2nd** | All Island English Day — Dictation (2022) |
| District **3rd** | Prepared Speech / Oratory — English Day (2023) |
| **Best Presenter** | Eastern Province Muslim Schools Leadership Programme (2023) |
| **Adjudicator** | 25+ speech & debate contests |
| **Founder** | English Pro Hub — English coaching & competition prep |
